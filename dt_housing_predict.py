...
dt_regressor.fit(X_train_encoded.values, y_train.values)

# Make predictions on the test data
print("Making predictions on test data...")
test_predictions = dt_regressor.predict(X_test_encoded.values)
...
output_path = '/root/Rajnandini/test code/dt_housing_submission.csv'
