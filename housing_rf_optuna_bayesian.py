...
def main():
    ...
    output_file = f"optuna_rf_bayesian_{best_params_str}_predictions.csv"
    ...
    if hasattr(best_rf, 'feature_importances_') and best_rf.feature_importances_ is not None:
        ...
        feature_importance_df.to_csv('optuna_rf_bayesian_feature_importances.csv', index=False)
        print(f"Feature importances saved to optuna_rf_bayesian_feature_importances.csv")
    ...
    # Save to CSV
    trials_df.to_csv('optuna_rf_bayesian_trials.csv', index=False)
    print(f"\nSaved all trial results to optuna_rf_bayesian_trials.csv")
    ...
    # Save the plot
    plt.savefig('optuna_rf_bayesian_optimization_history.png')
    print("Saved optimization history plot to optuna_rf_bayesian_optimization_history.png")
    ...
    with open('optuna_rf_bayesian_execution_time.txt', 'w') as f:
    ...
    param_importance_df.to_csv('optuna_rf_bayesian_param_importance.csv', index=False)
    print(f"Parameter importances saved to optuna_rf_bayesian_param_importance.csv")
    ...
    plt.tight_layout()
    plt.savefig('optuna_rf_bayesian_param_importance.png')
    print("Saved parameter importance plot to optuna_rf_bayesian_param_importance.png")
